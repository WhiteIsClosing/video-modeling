...
K   = 1
t_nn1  = K*(1./res**2/M)*trbm(res**2, numhid,   vh=M, hh=M, vv=0, random=True)
t_nn2  = K*(1./res**2/M)*trbm(numhid, 2*numhid, vh=M, hh=M, vv=0, random=True)
t_nn3  = K*(1./res**2/M)*trbm(2*numhid, numhid, vh=M, hh=M, vv=0, random=True)
save_path = 'seq/tbm_VV/run_aistats_'

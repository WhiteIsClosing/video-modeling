...
batch_size_train    = 10000  # batch size in batched traning (useless for other cases)
batch_size_test    = 2000  # batch size in batched traning (useless for other cases)
...
pretrain_epoch = 0  # pretrain epochs

en_shuffle  = True    # enable shuffling of the training data

en_decay    = True    # enable learning rate decay
max_decay   = 5      # after contiunous max_decay viloations, the lr will decay
epsl_decay  = 1e-6    # threashold of decaying the learning rate
...
num_batch_train = numseqs_train / batch_size_train
num_batch_test = numseqs_test / batch_size_test
